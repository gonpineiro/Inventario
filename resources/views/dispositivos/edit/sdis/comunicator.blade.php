          ...
          <form action="/update_comunicator/{{$host->id}}" method="post" name="form">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control uppercase" id="serial" value="{{$host->serial}}" name="serial"
                  required>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label for="abonado_id">SIM I </label> <a href="/card_sims" target=_blank> +</a>
            ...
            <div class="form-row">
              <div class="form-group col-md-5">
                ...
                <select class="form-control" name="cctv_id">
                  <option value="{{$host->cctv_id}}">{{$host->host->id}} - AB: {{$host->host->abonado->numero}} - C:
                    {{$host->host->abonado->departament->cliente->name}}</option>
                  @foreach ($cctvs as $cctv)
                  <option value="{{$cctv->id}}">{{$cctv->id}} - AB: {{$cctv->abonado->numero}}- C:
