...
@section('content')
  <div class="container">
    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9">
        <div class="card">
          <div class="card-header">Agregar Telefono IP</div>
            <div class="card-body">
                <form action="/add_telefonoip" method="post" name="form">
                  {{ csrf_field() }}
                  <div class="form-row">
                  ...
                  <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                          <label for="valor">Interno</label>
                          <input type="number" class="form-control" id="interno" placeholder="" name="interno">
                        </div>
                  </div>
