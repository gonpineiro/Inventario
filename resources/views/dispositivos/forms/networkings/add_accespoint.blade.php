...
@section('content')
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-md-9">
        <div class="card">
          <div class="card-header">Agregar Acces point</div>
            <div class="card-body">
                <form action="/add_accespoint" method="post" name="form">
                  {{ csrf_field() }}
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="acceso" class="form-control" id="acceso" name="acceso" placeholder=""  >
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="ssi_pass" placeholder="" name="ssid_pass" required>
                      </div>
                  </div>
                  ...
                  <div class="form-row">
                        <div class="form-group col-md">
                          ...
                          <textarea rows="10" cols="50" type="text" class="form-control" id="comentario" placeholder="" name="comentario" > </textarea>
                        </div>
                  </div>
