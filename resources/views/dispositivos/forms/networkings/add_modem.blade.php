...
@section('content')
  <div class="container">
    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9">
        <div class="card">
          <div class="card-header">Agregar Modem</div>
            <div class="card-body">
                <form action="/add_modem" method="post" name="form">
                  {{ csrf_field() }}
                  <div class="form-row">
                  ...
                  <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" id="ip_local" placeholder=""  name="ip_publica" pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" required>
                        </div>
                  </div>
                  <div class="form-row">
                        <div class="form-group col-md-6">
