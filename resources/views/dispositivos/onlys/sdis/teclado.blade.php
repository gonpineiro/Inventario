  ...
  <div class="row justify-content-md-center">
    <div class="col-md-9">
      <div class="card">
        ...
        <div class="card-body">
          <form action="/edit_teclado_sdi/{{$host->id}}" method="get" name="form-edit">
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control"
                  value="{{$host->host->name}} - AB: {{$host->host->abonado->numero}} - C: {{$host->host->abonado->departament->cliente->name}}"
                  readonly>
              </div>
              <div class="form-group col-md-5">
                <label for="cctv">Ubicacion</label>
                <input type="text" class="form-control" value="{{$host->zona}}" readonly>
              </div>
              <div class="form-group col-md-2">
                <label for="valor">Valor</label>
                <input type="text" class="form-control" value="{{$host->valor}}" readonly>
              </div>
            </div>
            <div class="form-row">
            ...
            @can ('tecladosdis.edit') <button class="btn btn-dark">Modificar</button> @endcan
          </form>
        </div>
      </div>
    </div>
