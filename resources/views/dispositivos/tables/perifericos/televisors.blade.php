      ...
      <div class="col cl-6">
        <h3>Televisores @can ('televisors.create') <a href="/form_televisor"> +</a> @endcan </h3>
          @switch($_SERVER["REQUEST_URI"])
            @case("/televisors")
                Habilitadas / <a href="/televisors_disable">Deshabilitadas</a> / <a href="/televisors_stock">Stock</a>
                @break
            @case("/televisors_disable")
                <a href="/televisors">Habilitadas</a> / Deshabilitadas / <a href="/televisors_stock">Stock</a>
                @break
            @case("/televisors_stock")
                <a href="/televisors">Habilitadas</a> / <a href="/televisors_disable">Deshabilitadas</a> / Stock
                @break
          @endswitch
          <br>
