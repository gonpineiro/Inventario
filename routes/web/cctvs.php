<?php
  ...
  Route::get('/camarasip_disable', 'SeguridadController@showCamarasIpDisable')->middleware('can:camaraips.show');
  Route::get('/camarasip_stock', 'SeguridadController@showCamarasIpStock')->middleware('can:camaraips.show');
  ...
  Route::get('/dvrs_disable', 'SeguridadController@showDvrsDisable')->middleware('can:dvrs.show');
  Route::get('/dvrs_stock', 'SeguridadController@showDvrsStock')->middleware('can:dvrs.show');
  ...
  Route::get('/camarasana_disable', 'SeguridadController@showCamarasAnaDisable')->middleware('can:camarasanas.show');
  Route::get('/camarasana_stock', 'SeguridadController@showCamarasAnaStock')->middleware('can:camarasanas.show');
