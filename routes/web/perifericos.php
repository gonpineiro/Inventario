...
Route::get('/monitors_disable', 'PerifericoController@showMonitorsDisable')->middleware('can:monitors.show');
Route::get('/monitors_stock', 'PerifericoController@showMonitorsStock')->middleware('can:monitors.show');
...
Route::get('/televisors_disable', 'PerifericoController@showTelevisorsDisable')->middleware('can:televisors.show');
Route::get('/televisors_stock', 'PerifericoController@showTelevisorsStock')->middleware('can:televisors.show');
...
Route::get('/teclados_disable', 'PerifericoController@showTecladosDisable')->middleware('can:teclados.show');
Route::get('/teclados_stock', 'PerifericoController@showTecladosStock')->middleware('can:teclados.show');
...
Route::get('/mouses_disable', 'PerifericoController@showMousesDisable')->middleware('can:mouses.show');
Route::get('/mouses_stock', 'PerifericoController@showMousesStock')->middleware('can:mouses.show');
...
Route::get('/web_cams_disable', 'PerifericoController@showWebcamDisable')->middleware('can:webcams.show');
Route::get('/web_cams_stock', 'PerifericoController@showWebcamStock')->middleware('can:webcams.show');
