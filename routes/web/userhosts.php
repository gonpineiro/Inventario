...
Route::get('/computadoras_disable', 'HostsController@showComputadorasDisable')->middleware('can:computadoras.show');
Route::get('/computadoras_stock', 'HostsController@showComputadorasStock')->middleware('can:computadoras.show');
...
Route::get('/notebooks_disable', 'HostsController@showNotebooksDisable')->middleware('can:notebooks.show');
Route::get('/notebooks_stock', 'HostsController@showNotebooksStock')->middleware('can:notebooks.show');
...
Route::get('/impresoras_disable', 'HostsController@showImpresorasDisable')->middleware('can:impresoras.show');
Route::get('/impresoras_stock', 'HostsController@showImpresorasStock')->middleware('can:impresoras.show');
...
Route::get('/telefoniaip_disable', 'HostsController@showTelefoniaipsDisable')->middleware('can:phoneips.show');
Route::get('/telefoniaip_stock', 'HostsController@showTelefoniaipsStock')->middleware('can:phoneips.show');
